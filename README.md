...
|---------|-------------|----------------|
| [Project 1](Project1%20(WEB%20STACK%20IMPLEMENTATION%20(LAMP%20STACK)%20IN%20AWS).md) | LAMP Stack Implementation | AWS EC2, Apache, MySQL, PHP |
| [Project 2](Project2%20WEB%20STACK%20IMPLEMENTATION%20(LEMP%20STACK).md) | LEMP Stack Implementation | AWS EC2, Nginx, MySQL, PHP |
| [Project 3](Project3%20TO-DO%20APPLICATION%20ON%20MERN%20WEB%20STACK.md) | MERN Stack Application | MongoDB, Express, React, Node.js |
| [Project 4](Project4%20MEAN%20STACK%20DEPLOYMENT%20TO%20UBUNTU%20IN%20AWS.md) | MEAN Stack Deployment | MongoDB, Express, Angular, Node.js |
...
| [Project 21](Project21.md) | Kubernetes Cluster | K8s, Manual K8s Setup, TLS Certificates |
...
- Start with Project 1-4 to understand web stack implementation
...
- **Jenkins Manual Pipeline**: Learn Jenkins fundamentals
- **Jenkins Pipeline as Code**: Automate with Jenkinsfile
- **Jenkins Advanced - Nodes & Agents**: Distributed builds
- **Jenkins Administration Guide**: Complete administration

### Phase 6: Infrastructure as Code
- Project 23: Ansible
- Project 24: Terraform
- Project 30: CloudFormation

### Phase 7: DevSecOps
- Project 25: Security in CI/CD
- Project 26: Vault
