...
8. Next, test that Apache HTTP server can respond to requests from the Internet. Open a browser and type the public IP of the Ubuntu instance: **http://3.235.248.184/:80** This outputs the Apache2 default page.
...
12. Reload the public IP to see changes to the apache2 default page.
