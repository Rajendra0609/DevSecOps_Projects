...
of **mysql client** for extra security.
...
script: `sudo mysql_secure_installation` Follow the prompts and answer appropriately to finish the process.
...
10.  Then grant privileges to remote_user:  `GRANT ALL ON test_db.* TO 'remote_user'@'%' WITH GRANT OPTION;`
